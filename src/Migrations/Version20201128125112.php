 ...
 */
final class Version20201128125112 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE favorite_sport (user_id INT NOT NULL, sport_id INT NOT NULL, INDEX IDX_AC0DC4F6A76ED395 (user_id), INDEX IDX_AC0DC4F6AC78BCF8 (sport_id), PRIMARY KEY(user_id, sport_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
